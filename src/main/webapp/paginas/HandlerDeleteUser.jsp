...
<%
	...
	try {
		...
		String sql = "UPDATE users SET IsActive=false, IsDeleted=true WHERE id=?";
        ...
        if (rowsUpdated > 0) {
            messages.add("Usuario eliminado com sucesso");
            session.setAttribute("success_message", messages);
        } else messages.add("Não foi possivel eliminar o usuario, tente novamente!");
